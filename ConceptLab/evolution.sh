...
#  --initializer_token concept --output_dir ./outputs/evolved/evolve_weapon_monster/ --mix_weights="[0.6,0.4]"
...
mkdir ./outputs/evolved/evolve_vehicle_animal/
python -m scripts.train_evolution \
 --parents_images_dirs="['./outputs/parents/parent_vehicle2/','./outputs/parents/parent_animal2/']" \
 --initializer_token concept --output_dir ./outputs/evolved/evolve_vehicle_animal/ --mix_weights="[0.57,0.43]"